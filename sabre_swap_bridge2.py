    ...
    **References:**
    ...
    def run(self, dag):
        ...
        while front_layer:
            ...
            if len(front_layer) == 0: raise Exception('The front layer cannot be empty!')
